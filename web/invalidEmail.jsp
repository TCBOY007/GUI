...
<head>
    ...
    <title>Login Unsuccessfully</title>
...
<div id='card' class="animated fadeIn">
  <div id='upper-side'>
    <?xml version="1.0" encoding="utf-8"?>
      ...
      <svg id="errormark" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="256" height="256" viewBox="0 0 256 256" xml:space="preserve">
  ...
  <div id='lower-side'>
    <p id='message'>
        Your account not EXISTING.<br>Please register a new account.
    </p>
    <a href="CustomerLogin.jsp" id="contBtn1">Login Page</a>
    <a href="CustomerRegister.jsp" id="contBtn2">Register</a>
  </div>
</div>
<!-- partial -->
